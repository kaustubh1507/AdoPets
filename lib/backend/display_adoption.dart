  ...
  Widget build(BuildContext context) {
       return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text("AVAILABLE ADOPTIONS", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
        ),
                ...
                children: snapshot.data!.docs.map((e) => Padding(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text("Breed : ${e['Breed']}",style: TextStyle(fontSize: 26),),
                      trailing: Text("Age :  ${e['Age']}",style: TextStyle(fontSize: 18),),
                      ),
                  ),
                ),
                  ).toList()
